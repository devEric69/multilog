...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure butCounterClick(Sender: TObject);
...
begin
    ...
    with goLogger do begin
      ...
      FilterDynamic_forWhatReasonsToLogActually:= [lwInfo, lwIPC];
      EnterMethod(Sender,'TestLogClick');
      oList:= TStringList.Create;
      with oList do begin
        Add('xxx');
...
procedure TForm1.butCounterClick(Sender: TObject);
var
  i: integer;
begin
  with goLogger do begin
    Send('5 incrementations of CounterNum1:');
	  for i:= 1 to 5 do begin
  	  IncCounter('CounterNum1');
 	  end;
    Send('5 incrementations of CounterNum2:');
	  for i:= 1 to 5 do begin
  	  IncCounter('CounterNum2');
 	  end;
    Send('1 decrementration of CounterNum1:');
 	  DecCounter('CounterNum1');
    Send('reset of CounterNum2:');
 	  ResetCounter('CounterNum2');
  end;
end;
...
var
	iDummy: integer = 0; iFakeDummyCalc: integer = 0;
begin
...
var
	iFakeDummy: integer = 0; iFakeDummyCalc: integer = 0;
begin
