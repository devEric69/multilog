...
begin
  SendInfo(FsetFilterDynamic_forWhatReasonsToLogActually,AText);
end;


procedure TIntegratedLogger.SendInfo(const AText: String; Args: array of const);
begin
  SendInfo(FsetFilterDynamic_forWhatReasonsToLogActually,AText,Args);
end;
...
begin
  SendInfo(FsetFilterDynamic_forWhatReasonsToLogActually,AText,APoint);
end;
...
begin
  SendException(FsetFilterDynamic_forWhatReasonsToLogActually,AText,AException);
end;
...
begin
  SendWarning(FsetFilterDynamic_forWhatReasonsToLogActually,AText);
end;


procedure TIntegratedLogger.SendError(const AText: String);
begin
  SendError(FsetFilterDynamic_forWhatReasonsToLogActually,AText);
end;
...
begin
  EnterMethod(FsetFilterDynamic_forWhatReasonsToLogActually,nil,AMethodName,AMessage);
end;
...
begin
  EnterMethod(aSetOfFilterDynamicOverloadOneShot,nil,AMethodName,AMessage);
end;


procedure TIntegratedLogger.EnterMethod(Sender: TObject; const AMethodName: String; const AMessage: String);
begin
  EnterMethod(FsetFilterDynamic_forWhatReasonsToLogActually,Sender,AMethodName,AMessage);
end;


procedure TIntegratedLogger.ExitMethod(const AMethodName: String; const AMessage: String);
begin
  ExitMethod(FsetFilterDynamic_forWhatReasonsToLogActually,nil,AMethodName,AMessage);
end;


procedure TIntegratedLogger.ExitMethod(Sender: TObject; const AMethodName: String; const AMessage: String);
begin
  ExitMethod(FsetFilterDynamic_forWhatReasonsToLogActually,Sender,AMethodName,AMessage);
end;
...
begin
  ExitMethod(aSetOfFilterDynamicOverloadOneShot,nil,AMethodName,AMessage);
end;
...
begin
  SubEventBetweenEnterAndExitMethods(FsetFilterDynamic_forWhatReasonsToLogActually,AText);
end;
...
{$Include getdescriptionof_sql_exception.inc}
end;
